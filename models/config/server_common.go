...
type ServerCommonConf struct {
	...
	// TlsOnly specifies whether to only accept TLS-encrypted connections. If
	// "tls_cert_file", "tls_key_file" are valid, the server will use this
	// supplied tls configuration. Otherwise, the server will use the tls
	// configuration generated by itself. By default, the value is false.
	TlsOnly bool `json:"tls_only"`
	// TLSCertFile specifies the path of the cert file that the server will
	// load. When "tls_only" is true, it will works with "tls_key_file" and
	// "tls_trusted_ca_file".
	TLSCertFile string `json:"tls_cert_file"`
	// TLSKeyFile specifies the path of the secret key that the server will
	// load. When "tls_only" is true, it will works with "server_tls_cert_path" and
	// "tls_trusted_ca_file".
	TLSKeyFile string `json:"tls_key_file"`
	// TLSTrustedCaFile specifies the paths of the client cert files that the
	// server will load. If "tls_cert_file" is not empty, it only works
	// when "tls_only" is true and "tls_cert_file" and "tls_key_file" are valid.
