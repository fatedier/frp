...
type ClientCommonConf struct {
	...
	// client will load the supplied tls configuration. Otherwise, it will
	// load the tls configuration generated by itself.
	...
	// It only works when "tls_enable", "tls_cert_file" and "tls_key_file" are
	// valid.
