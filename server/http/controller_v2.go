...
func (c *Controller) APIV2SystemInfo(ctx *httppkg.Context) (any, error) {
	...
	return model.V2SystemInfoResp{
		...
		Config: model.V2SystemInfoConfigResp{
			...
			AutoTransportEnabled:   info.AutoTransportEnabled,
			AutoTransportProtocols: info.AutoTransportProtocols,
		},
		Status: model.V2SystemInfoStatusResp{
			...
			AutoNegotiationSuccess:         info.AutoNegotiationSuccess,
			AutoNegotiationFailure:         info.AutoNegotiationFailure,
			AutoTransportSelections:        info.AutoTransportSelections,
			AutoTransportClientCounts:      info.AutoTransportClientCounts,
			AutoTransportSwitchCounts:      info.AutoTransportSwitchCounts,
			AutoTransportIllegalSelections: info.AutoTransportIllegalSelections,
		},
	}, nil
}
